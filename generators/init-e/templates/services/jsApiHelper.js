...
import jsApiOpenLink from '@ali/dingtalk-jsapi/api/biz/util/openLink';
import jsApiClose from '@ali/dingtalk-jsapi/api/biz/navigation/close';
...
export const openLink = withLogger(jsApiOpenLink, 'biz.util.openLink');
export const close = withLogger(jsApiClose, 'biz.navigation.close');
